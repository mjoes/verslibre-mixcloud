...
filepath_json = f'/Users/mortenslingsby/Music/VersLibre/code/verslibre-mixcloud/credentials.json'
...
def download(file_id, file_name):
    ...
    file = drive.CreateFile({'id': file_id})
    file.GetContentFile(f"/Users/mortenslingsby/Music/VersLibre/code/verslibre-mixcloud/tmp/{file_name_new}", chunksize=1004857600)
